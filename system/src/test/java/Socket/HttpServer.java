  ...
  public static void service(Socket socket)
  {
    new Thread(){
      public void run(){
		...
		//FileInputStream writehtml = new FileInputStream(new File("C:\\Users\\meixl\\Desktop\\个人资料.txt"));
          
          InputStream writehtml = HttpServer.class.getClassLoader().getResourceAsStream("qq.properties");
          outSocket.write("\r\n".getBytes()); 
