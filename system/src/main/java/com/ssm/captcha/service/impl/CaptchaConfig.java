...
/**
 * @name        CaptchaConfig
 * @description 验证码是否显示配置, 登录错误三次打开验证码
 * @author      meixl
 * @date        2017年8月9日上午10:20:19
 * @version
 */
@Component
public class CaptchaConfig implements SystemConfigListener{
	
	public static String CAPTCHA_AFTER3 = "AFTER3";    //登录失败3次启用验证码
	public static String CAPTCHA_DISABLE = "DISABLE";  //禁用验证码
	public static String CAPTCHA_ENABLE = "ENABLE";    //启用验证码
    ...
    private String redisCatalog = "ssm:login:";
