 ...
 */
@Service
@Queue(queue="hap:queue:email:vip")
public class VipMessageReceiver implements IQueueListener<Message> {
	
	private static final Logger logger = LoggerFactory.getLogger(VipMessageReceiver.class);
	
	private String queue ="hap:queue:email:vip";
