...
public class TestLock {
	...
	public static void main(String[] args) {
		...
		InputStream input = TestLock.class.getClassLoader().getResourceAsStream("config.properties");
		...
		System.out.println("读取配置文件数据库驱动 : driver ="+ driver);
