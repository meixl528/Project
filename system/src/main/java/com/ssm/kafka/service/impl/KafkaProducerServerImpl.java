...
public class KafkaProducerServerImpl implements KafkaProducerServer{
     ...
     */
    @Override
    public Map<String,Object> sndMesForTemplate(String topic, Object value, String ifPartition,Integer partitionNum, String role) throws JsonProcessingException{
